...
<div
	class="relative flex h-screen flex-col overflow-hidden pixel-art-bg"
	style="background-image: url('{getBackgroundImage()}');"
>
	<!-- Game Name Header - Fixed Overlay at Top -->
	<div class="absolute top-0 left-0 right-0 z-10 w-full bg-black/50 backdrop-blur-sm p-4 text-center">
